...
@XmlType(name = "Country", namespace = "http://schemas.datacontract.org/2004/07/UFO.Server.Domain", propOrder = {
    "code",
    "name"
})
    ...
    extends DomainObject
{
    ...
    @XmlElementRef(name = "Code", namespace = "http://schemas.datacontract.org/2004/07/UFO.Server.Domain", type = JAXBElement.class, required = false)
