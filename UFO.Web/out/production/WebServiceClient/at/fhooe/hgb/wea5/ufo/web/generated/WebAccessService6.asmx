...
<wsdl:definitions xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://ufo.at/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:s1="http://microsoft.com/wsdl/types/" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" targetNamespace="http://ufo.at/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
    <s:schema elementFormDefault="qualified" targetNamespace="http://ufo.at/">
      ...
      <s:element name="GetAutoCompletion">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="keyword" type="s:string" />
          </s:sequence>
      ...
      <s:element name="GetAutoCompletionResponse">
        <s:complexType>
          <s:sequence>
            <s:element minOccurs="0" maxOccurs="1" name="GetAutoCompletionResult" type="tns:ArrayOfString" />
          </s:sequence>
        </s:complexType>
      </s:element>
  ...
  <wsdl:message name="GetAutoCompletionSoapIn">
    <wsdl:part name="parameters" element="tns:GetAutoCompletion" />
  </wsdl:message>
  <wsdl:message name="GetAutoCompletionSoapOut">
    <wsdl:part name="parameters" element="tns:GetAutoCompletionResponse" />
  </wsdl:message>
  <wsdl:portType name="WebAccessServiceSoap">
    ...
    <wsdl:operation name="GetAutoCompletion">
      <wsdl:input message="tns:GetAutoCompletionSoapIn" />
      <wsdl:output message="tns:GetAutoCompletionSoapOut" />
    </wsdl:operation>
  </wsdl:portType>
  <wsdl:binding name="WebAccessServiceSoap" type="tns:WebAccessServiceSoap">
    ...
    <wsdl:operation name="GetAutoCompletion">
      <soap:operation soapAction="http://ufo.at/GetAutoCompletion" style="document" />
      <wsdl:input>
        <soap:body use="literal" />
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="WebAccessServiceSoap12" type="tns:WebAccessServiceSoap">
    ...
    <wsdl:operation name="GetAutoCompletion">
      <soap12:operation soapAction="http://ufo.at/GetAutoCompletion" style="document" />
      <wsdl:input>
        <soap12:body use="literal" />
      </wsdl:input>
      <wsdl:output>
