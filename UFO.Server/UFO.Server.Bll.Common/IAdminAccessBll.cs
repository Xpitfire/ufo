...
namespace UFO.Server.Bll.Common
{
    public interface IAdminAccessBll : IAuthAccessBll
    {
        ...
        bool SendNotification(SessionToken token, Notification notification);
        ...
        bool DelayPerformance(SessionToken token, Performance oldPerformance, Performance newPerformance);
