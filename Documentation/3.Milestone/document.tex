...
\newcommand{\AuthorFullID}{\AuthorFirstName \xspace \AuthorLastName \xspace (\MatrNr)}

\newcommand{\SubjectTitle}{SWK5 UEG2 SEv WS15/16}
\newcommand{\ExerciseTitle}{Ausbaustufe 2}
...
\begin{document}
		...
		\includepdf[scale=1, pages={1-5}, angle=0]{./specs/Projekt-SWK5-WEA5-VZ-Anforderungsdefinition.pdf}
		
    \includepdf[scale=1, pages={1}, angle=0]{./specs/Projekt-SWK5-WEA5-VZ-Ausbaustufe1.pdf}

    % sections
    \input{./doc/section_1.tex}
    \newpage
		\input{./doc/section_2.tex}
		\newpage
		\input{./doc/section_3.tex}
		\newpage
		
		\includepdf[scale=1, pages={1}, angle=0]{./specs/Projekt-SWK5-WEA5-BB-Ausbaustufe2.pdf}
		
		\input{./doc/section_4.tex}
		
		\includepdf[scale=1, pages={1}, angle=0]{./specs/Projekt-SWK5-WEA5-VZ-Ausbaustufe3.pdf}
		
		\input{./doc/section_5.tex}
